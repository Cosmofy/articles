...
async def lifespan(app: FastAPI):
    settings = Settings()
    catalog = load_article_catalog(settings.articles_data_path)
...
app = FastAPI(
    ...
    description="Provides validated, searchable, cached, and rate-limited article data to Cosmofy's Java GraphQL federation.",  # longer explanation displayed on the documentation page
    version="1.0.0",
